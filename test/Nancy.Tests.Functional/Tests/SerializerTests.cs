namespace Nancy.Tests.Functional.Tests
{
    ...
    public class SerializerTests
    {
        ...
        [Fact]
        public async Task Should_BindTo_Local_With_JsonConfigutation()
        {
            // Given
            ...
            var bootstrapper = new ConfigurableBootstrapper(
                configuration =>
                {
                    configuration.Configure(environment => environment.Json(dateTimeStyleConversion: DateTimeStyles.AssumeLocal));
                    configuration.Modules(new Type[] { typeof(SerializerTestModule) });
                });
